...
namespace {
	//HPの位置
	const Vector3 n_position_HP{ -760.0f,-360.0f,0.0f };
	//HPの位置
	const Vector3 n_position_Damage{ -760.0f,-360.0f,0.0f };
	//BとCの基点
...
bool Player_HP_UI::Start()
{
	m_game = FindGO<Game>("game");
	m_player = FindGO<Player>("player");//場所を教える
	//画像設定
	m_hpUI_A.Init("Assets/Sprite/HP_UI_RED.DDS", 900.0f, 600.0f);
	//画像設定
	m_hpUI_B.Init("Assets/Sprite/HP_UI.DDS", 900.0f, 600.0f);
	//位置設定
...
void Player_HP_UI::AdjustmentTransparent()
{
